 ...
 * @author varsh
 */
public class supplier_landing extends javax.swing.JFrame {

    /**
     * Creates new form welcome_page
     */
    public supplier_landing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        main_panel.add(back_button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, -1, -1));

        back_button2.setBackground(new java.awt.Color(0, 204, 204));
        back_button2.setFont(new java.awt.Font("Segoe UI", 1, 30)); // NOI18N
        ...
        main_panel.add(back_button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1, 30));
    ...
    private void register_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register_buttonActionPerformed
       supplier_register s = new supplier_register();
        dispose();
        s.setVisible(true);
